...
export const metadata: Metadata = {
  ...
  twitter: { card: "summary_large_image", title: "GregLabs - Things for the web", description: "Security systems, APIs, web applications, and digital experiences by GregLabs.", images: ["/og.png"] },
